...
namespace unispace
{
	...
	public:
		 ...
		 * @return	A DM_RESULT.
		 *************************************************************************/
		virtual DM_RESULT find_dataset_auth(
			const us_uuid& uuid, us_dataset_auth_basic_meta* out_meta);
		 ...
		 *************************************************************************/
		virtual DM_RESULT find_dataset_auth(
			const us_ustring& name, us_dataset_auth_basic_meta* out_meta);
		 ...
		 * @return	A DM_RESULT.
		 *************************************************************************/
		virtual DM_RESULT update_dataset_auth(us_dataset_auth_basic_meta& meta)const;
