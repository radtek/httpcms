...
#define __US_DATA_MANAGER_HPP__
	...
	#ifdef _US_DATA_MANAGER_LIB
		#ifdef __GNUC__
			#define _US_DATA_MANAGER_DLL __attribute__ ((dllexport))
		#else
			#define _US_DATA_MANAGER_DLL __declspec(dllexport)
		#endif
	#else
		#ifdef __GNUC__
			#define _US_DATA_MANAGER_DLL __attribute__ ((dllimport))
		#else
			#define _US_DATA_MANAGER_DLL __declspec(dllimport)
		#endif
	#endif
	#define _US_DATA_MANAGER_LOCAL
#else
	#if __GNUC__ >= 4
		#define _US_DATA_MANAGER_DLL    __attribute__ ((visibility ("default")))
		#define _US_DATA_MANAGER_LOCAL  __attribute__ ((visibility ("hidden")))
	#else
...
namespace unispace
{
    ...
    inline const char* get_dm_result_str(DM_RESULT code)
    {
        switch (code)
        {
        case unispace::SUCCESS:
            return "success";
            break;
        case unispace::ALREADY_EXISTS:
            return "already exists";
            break;
        case unispace::DATABASE_EXCEPTIONS:
            return "database exceptions";
            break;
        case unispace::META_EXCEPTION:
            return "metadata exception";
            break;
        case unispace::GRID_ID_INVALID:
            return "grid id invalid";
            break;
        case unispace::PROGRAM_EXCEPTION:
            return "program self exception";
            break;
        case unispace::PARAMETER_INVALID:
            return "parameter invalid";
            break;
        case unispace::GET_RESULT_FAILD:
            return "get operator result faild";
            break;
        case unispace::DATA_PARSE_FAILD:
            return "data parse failed";
            break;
        case unispace::NOT_FOUND:
            return "not found";
            break;
        case unispace::UNKNOWN_ERROR:
        default:
